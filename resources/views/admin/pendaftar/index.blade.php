...
<div class="relative" id="exportDropdown">
    ...
    <div id="exportMenu" class="hidden absolute right-0 top-full mt-1.5 bg-white border border-gray-100
      ...
      <a href="{{ route('admin.pendaftar.export', array_merge(request()->only('gender'), ['format'=>'csv'])) }}"
      ...
      <a href="{{ route('admin.pendaftar.export', array_merge(request()->only('gender'), ['format'=>'excel'])) }}"
         class="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors">
      ...
      <a href="{{ route('admin.pendaftar.export', array_merge(request()->only('gender'), ['format'=>'pdf'])) }}"
         class="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors">
